...
ob_start();
		...
		if(isset($_POST['Add']))
		{
			...
			$query=" UPDATE category set Id=$Id,Name='$Name' where id=$Id";
        ...
        <div class="col-sm-3" style="background-color: #fff;padding:20px;margin:10px;">
            ...
            <form action="#" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $Name; ?>" name="Name" id="Name" placeholder=" ">
                </div>
        
                <button type="submit" name="Add" value="Update" class="btn btn-primary">Update</button>
            </form>
